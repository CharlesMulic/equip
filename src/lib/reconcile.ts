...
function registryDefToContent(def: RegistryDef): AugmentContent {
  ...
  return {
    ...
    registryStatus: def.registryStatus || def.status || undefined,
    listed: def.listed,
    reviewStatus: def.reviewStatus || undefined,
    trustTier: def.trustTier || undefined,
    trustState: def.trustState as unknown as Record<string, unknown> | undefined,
    recommendedMcpPath: def.recommendedMcpPath as unknown as Record<string, unknown> | undefined,
    syncSource: def.syncSource || undefined,
    syncSourceName: def.syncSourceName || undefined,
