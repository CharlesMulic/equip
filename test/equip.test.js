...
describe("reconcileState", () => {
  ...
  function setupTempHome() {
    hermeticHome = setupHermeticHome("equip-reconcile-home-");
...
describe("config migration", () => {
  ...
  function setupMigrationHome() {
    hermeticHome = setupHermeticHome("equip-migrate-home-");
    tempHome = hermeticHome.homeDir;
  ...
  function teardownMigrationHome() {
    hermeticHome.restore();
    hermeticHome = null;
    tempHome = null;
  }

  beforeEach(setupMigrationHome);
  afterEach(teardownMigrationHome);
